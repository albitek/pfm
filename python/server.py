...
def get_access_token():
    ...
    # store item_id, access_token in the file
...
if __name__ == '__main__':
    # Added a new cli argument requiring the filename
    # for where access token data will be stored
    global token_file_name
    if len(sys.argv) != 2:
        print('Usage: python server.py <token-filename>')
        sys.exit(-1)
